                    ...
                    <div className="w-full max-w-xl space-y-8">
                        ...
                        <div className="space-y-3 animate-in fade-in slide-in-from-bottom-4 duration-700">
                            ...
                            <p className="text-base text-slate-600 leading-relaxed">
                                We improve your real content. No fake keywords added.
                            </p>
                        </div>
                    ...
                    {[...Array(2)].map((_, setIndex) => (
                        <div key={setIndex} className="flex items-center gap-12">
                            <div className="inline-flex items-center gap-4">
                                ...
                                <span className="font-black text-slate-900 text-xs">Rahul S.</span>
                                <span className="text-slate-500 text-xs">"Got interview in 2 days"</span>
                            </div>
                            <div className="inline-flex items-center gap-4">
                                <div className="flex gap-0.5">
                                    {[...Array(5)].map((_, i) => (
                                ...
                                <span className="font-black text-slate-900 text-xs">Anita M.</span>
                                <span className="text-slate-500 text-xs">"Clean format helped"</span>
                            </div>
                            <div className="inline-flex items-center gap-4">
                                <div className="flex gap-0.5">
                                    {[...Array(5)].map((_, i) => (
                                ...
                                <span className="font-black text-slate-900 text-xs">John D.</span>
                                <span className="text-slate-500 text-xs">"Simple layout"</span>
                            </div>
                            <div className="inline-flex items-center gap-4">
                                <div className="flex gap-0.5">
                                    {[...Array(5)].map((_, i) => (
                                ...
                                <span className="font-black text-slate-900 text-xs">Priya K.</span>
                                <span className="text-slate-500 text-xs">"Honest tool"</span>
                            </div>
                            <div className="inline-flex items-center gap-4">
                                <div className="flex gap-0.5">
                                    {[...Array(5)].map((_, i) => (
                                ...
                                <span className="font-black text-slate-900 text-xs">Mark T.</span>
                                <span className="text-slate-500 text-xs">"Straightforward"</span>
                            </div>
                        </div>
                    ))}
                </div>
