  ...
  <div className="min-h-screen bg-gray-50 py-12 px-4">
    <div className="max-w-2xl mx-auto prose prose-gray">
      ...
      <section className="mt-6 text-gray-700 space-y-4">
        ...
        <p className="text-sm text-gray-500 mt-8"><Link to="/contact" className="text-blue-600 hover:underline">Contact</Link> · <Link to="/terms" className="text-blue-600 hover:underline">Terms</Link> · <Link to="/privacy" className="text-blue-600 hover:underline">Privacy</Link></p>
      </section>
    </div>
  </div>
);
