  ...
  <div className="min-h-screen bg-gray-50 py-12 px-4">
    <div className="max-w-2xl mx-auto prose prose-gray">
      ...
      <section className="mt-6 text-gray-700 space-y-4">
        <p><strong>Service description.</strong> HexaCV provides an ATS-optimized resume builder and optional paid Advanced ATS Rewrite. The service is provided as-is for creating and downloading resume documents.</p>
        ...
        <p><strong>Payment terms.</strong> Payment for Advanced ATS Rewrite is one-time (₹49). Payment is processed via PayU. By completing payment you agree to these terms and our refund policy.</p>
