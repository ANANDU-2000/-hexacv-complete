  ...
  try {
    const response = await fetch(`${API_BASE_URL}/api/categorization`, {
      ...
      body: JSON.stringify({
        ...
        detectedRoleCategory: insights.detectedRoleCategory,
        detectedSpecificRole: insights.detectedSpecificRole,
        experienceLevel: insights.experienceLevel,
        industryType: insights.industryType,
        jdKeywords: insights.jdKeywords,
        recommendedTemplates: insights.recommendedTemplates,
        selectedTemplate: insights.selectedTemplate,
        atsScoreRange: insights.atsScoreRange,
        sessionStatus: insights.sessionStatus,
        stepReached: insights.stepReached
      }),
    });
    ...
    console.error('Error saving categorized insights:', error);
