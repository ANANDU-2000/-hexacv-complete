...
export async function getRoleMarketIntelligence(
  ...
  // Generate fresh intelligence using OpenAI (ONCE per role+market+exp)
  console.log('🔄 Generating fresh role market intelligence (OpenAI call)');
...
/**
 * Generate role market intelligence using OpenAI
...
Return ONLY valid JSON, no markdown.`;
  ...
  try {
    ...
    console.error('OpenAI role market intelligence error:', error);
    return getFallbackIntelligence(role, market, experienceLevel);
  }
}
