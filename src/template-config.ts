...
/**
 * Template 1 Free: ATS Classic (FREE_V1)
 * Maximum ATS compatibility, single column, Times New Roman font
 * Designed for precise structural replication of standard resume format
 * LOCKED: No changes unless ATS rules change
 */
...
- Use standard section names (PROFESSIONAL SUMMARY, SKILLS, EXPERIENCE, PROJECTS, EDUCATION)
...
/**
 * Template Registry
 * SINGLE FREE TEMPLATE - No paid templates
 */
 ...
 * Always returns the free template
 */
export function getTemplateConfig(templateId: string): TemplateConfig | undefined {
  return TEMPLATE_CONFIGS[templateId] || TEMPLATE_CONFIGS.template1free;
}
